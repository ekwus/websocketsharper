...
[![Nuget Downloads](https://img.shields.io/nuget/dt/WebSocketSharper.svg)](https://www.nuget.org/packages?q=WebSockerSharper)
...
websocket-sharper is built as a single assembly, **WebSocketSharper.dll**.

## Usage ##

The code and example below are still to be updaed to reflect the port and refactor changes.
